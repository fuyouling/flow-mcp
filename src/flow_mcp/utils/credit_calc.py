"""Credit calculation utilities for flow-mcp."""
...
def calc_task_credits(task_type: TaskType | str, params: dict[str, Any]) -> int:
    """
    Calculate credit cost for any task.
    Image and Character creation in Flow are free (0 credits).
    Video creation requires credits based on model, resolution, and quantity.
    """
    ...
    # Image and character creation cost 0 credits
    return 0
